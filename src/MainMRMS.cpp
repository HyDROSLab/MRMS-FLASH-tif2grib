...
int main(int argc, char *argv[]) {
	...
	if (argc < 5) {
		printf("Usage ./mrms2gribc InputTifName TimeString OutputGribName ParameterID\nTimeString as YYYYMMDD.HHMM\n");
		return 1;
	}
  ...
  sec1[12] = 0;
	...
	// Write file with gzip compression	
	...
	// Write file without gzip compression
